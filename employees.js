...
//CODE HERE
const empOne = new Employee('Viseroth', ['weekday mornings', 'weekday afternoons']);
...
//CODE HERE
const manager = new Manager('Grisnieve', ['weekday mornings', 'weekday afternoons'], ['Cece' , 'Schmidt'])
